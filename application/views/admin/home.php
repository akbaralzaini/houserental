...
<html class="fixed">
	<head>
		...
		<link rel="stylesheet" href="<?= base_url(); ?>asset/admin/vendor/jquery-ui/css/ui-lightness/jquery-ui-1.10.4.custom.css" />
		<link rel="stylesheet" href="<?= base_url(); ?>asset/admin/vendor/bootstrap-multiselect/bootstrap-multiselect.css" />
		<link rel="stylesheet" href="<?= base_url(); ?>asset/admin/vendor/morris/morris.css" />
	...
	<body>
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?= base_url(); ?>asset/admin/images/!sample-user.jpg" alt="Joseph Doe Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?= base_url(); ?>asset/admin/images/!sample-user.jpg" alt="Joseph Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?= base_url(); ?>asset/admin/images/!sample-user.jpg" alt="Joe Junior" class="img-circle" />
												</figure>
							...
							<section class="panel">
								...
								<div class="panel-body">
									...
									<script>
										...
										// See: <?= base_url(); ?>asset/admin/javascripts/dashboard/examples.dashboard.js for more settings.
										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src="<?= base_url(); ?>asset/admin/images/!logged-user.jpg">
												</div>
												...
												<li>
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href="<?= base_url(); ?>asset/admin/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
																<img class="img-responsive" width="215" src="<?= base_url(); ?>asset/admin/images/projects/project-4.jpg">
																<span class="zoom">
							...
							<div class="sidebar-widget widget-friends">
								...
								<ul>
									<li class="status-online">
										<figure class="profile-picture">
											<img src="<?= base_url(); ?>asset/admin/images/!sample-user.jpg" alt="Joseph Doe" class="img-circle">
										</figure>
										<div class="profile-info">
		...
		<script src="<?= base_url(); ?>asset/admin/vendor/jquery-ui/js/jquery-ui-1.10.4.custom.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jquery-ui-touch-punch/jquery.ui.touch-punch.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jquery-appear/jquery.appear.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/bootstrap-multiselect/bootstrap-multiselect.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jquery-easypiechart/jquery.easypiechart.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/flot/jquery.flot.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/flot-tooltip/jquery.flot.tooltip.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/flot/jquery.flot.pie.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/flot/jquery.flot.categories.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/flot/jquery.flot.resize.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jquery-sparkline/jquery.sparkline.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/raphael/raphael.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/morris/morris.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/gauge/gauge.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/snap-svg/snap.svg.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/liquid-meter/liquid.meter.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jqvmap/jquery.vmap.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jqvmap/data/jquery.vmap.sampledata.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jqvmap/maps/jquery.vmap.world.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jqvmap/maps/continents/jquery.vmap.africa.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jqvmap/maps/continents/jquery.vmap.asia.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jqvmap/maps/continents/jquery.vmap.australia.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jqvmap/maps/continents/jquery.vmap.europe.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jqvmap/maps/continents/jquery.vmap.north-america.js"></script>
		<script src="<?= base_url(); ?>asset/admin/vendor/jqvmap/maps/continents/jquery.vmap.south-america.js"></script>
		...
		<!-- Examples -->
		<script src="<?= base_url(); ?>asset/admin/javascripts/dashboard/examples.dashboard.js"></script>
	</body>
</html>