							...
							<div class="table-responsive dt-responsive">
								<table id="setting-default" class="table table-striped table-bordered nowrap">
									...
									<tbody>
										...
										<tr>
											<td><a href="<?= base_url() ?>admin/rumah?id_rumah=<?= $row->id_rumah ?>"><?= $row->nama_rumah ?></a></td>
											<td><?= $row->nama ?></td>
											<td><?= $row->harga ?></td>
											...
											<td>
												<a href="<?= base_url() ?>admin/verifikasirumah?id_r=<?= $row->id_rumah ?>"><button type="button" class="btn  btn-icon btn-primary"><i class="fa fa-check-square"></i> Verifikasi</button></a>
												<a href="<?= base_url() ?>admin/deleterumah?id_r=<?= $row->id_rumah ?>"><button type="button" class="btn  btn-icon btn-danger"><i class="feather icon-trash-2"></i> Hapus</button></a>
